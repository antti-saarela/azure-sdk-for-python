    ...
    try:
        ...
        with project_client:
            ...
            message = project_client.agents.create_message(
                ...
                role="user",
                content=(
                    # ja tarkista että viitatun ohjeen tila on 'Valmis'. Anna tasan yksi lähdeviite. Lähdeviitteen linkin tulee päättyä tekstiin '/definition'"
                    "Haluan ajantasaista tietoa hakemuksesta erityishuoltoon. Käytä lähteenä THL:n Sosmeta palvelua"
                ),
            )
